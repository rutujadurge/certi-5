...
options = ("View/Verify Certificate using Certificate ID", "Verify Certificate using PDF")
...
if selected == options[1]:
    ...
    certificate_id = form.text_input("Enter the Certificate ID", value=st.experimental_get_query_params().get('certificate_id', [''])[0])
